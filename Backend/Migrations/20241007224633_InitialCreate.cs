        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PatientDoctorId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PatientUsername = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    DoctorUsername = table.Column<string>(type: "nvarchar(50)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientDoctors", x => x.PatientDoctorId);
                    table.ForeignKey(
                        name: "FK_PatientDoctors_Doctors_DoctorUsername",
                        column: x => x.DoctorUsername,
                        principalTable: "Doctors",
                        principalColumn: "Username",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PatientDoctors_Patients_PatientUsername",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppointmentType = table.Column<short>(type: "smallint", nullable: false),
                    AppointmentStatus = table.Column<short>(type: "smallint", nullable: false),
                    PatientDoctorId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_PatientDoctors_PatientDoctorId",
                        column: x => x.PatientDoctorId,
                        principalTable: "PatientDoctors",
                        principalColumn: "PatientDoctorId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_PatientDoctorId",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientDoctors_DoctorUsername",
                table: "PatientDoctors",
                column: "DoctorUsername");

            migrationBuilder.CreateIndex(
                name: "IX_PatientDoctors_PatientUsername",
                table: "PatientDoctors",
